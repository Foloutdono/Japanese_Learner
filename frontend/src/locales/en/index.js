...
const onboarding = {
  ...
  onbMapMilestone: (level, items, month) => `${level} complete around ${month} — ${items.toLocaleString('en')} items known`,
  ...
  onbTourTodayDesc: 'Everything due for review, across every line — the daily appointment that makes it all stick.',
  onbTourLinesTitle: 'The study lines',
  onbTourLinesDesc: 'Kana, vocabulary, kanji, grammar — each line with its own modes, from multiple choice to writing by hand.',
  onbTourAnalyzerTitle: 'The analyzer',
  onbTourAnalyzerDesc: 'Paste a sentence, a photo or a video: segmentation, readings, level — and mine cards straight out of it.',
  onbTourExamsTitle: 'Mock exams',
  onbTourExamsDesc: 'Papers built to the JLPT format, generated for you, timed and scored.',
  ...
  settingsRedoPlacement: 'Retake the placement test',
