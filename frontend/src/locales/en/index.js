...
const profile = {
  ...
  punched:           'Punched',
  // What each 記念乗車券 is for — read by turning the ticket over.
  badgeReq: {
    first_steps:   'Your first review.',
    week_streak:   'Seven days in a row.',
    month_streak:  'Thirty days in a row.',
    kanji_100:     'A hundred cards mastered.',
    perfectionist: 'Ten perfect answers in a row.',
    dedicated:     'Five hundred reviews.',
  },
  ranking:           'Ranking',
  ...
  east:              'East',
  west:              'West',
  tonight:           'Within reach tonight',
  tonightDaruma:     (n) => `${n} more and the daruma gets its second eye`,
  tonightBadge:      (n, glyph) => `${n} more and the ${glyph} ticket punches`,
  tonightChase:      (xp, who) => `${xp} XP passes ${who}`,
