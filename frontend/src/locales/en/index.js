...
const video = {
  ...
  captionsServerBlocked: "This server can't fetch captions from YouTube. That's about where the request comes from, not about your video — YouTube blocks datacenter IPs.",
  captionsTryPaste:    'Paste the transcript instead — it takes about ten seconds and works every time.',
