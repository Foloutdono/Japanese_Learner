...
const video = {
  ...
  captionsServerBlocked: "Ce serveur ne peut pas récupérer les sous-titres depuis YouTube. C'est lié à l'origine de la requête, pas à votre vidéo — YouTube bloque les IP de datacenter.",
  captionsTryPaste:    'Collez plutôt la transcription — cela prend une dizaine de secondes et fonctionne à chaque fois.',
