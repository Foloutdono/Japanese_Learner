...
const onboarding = {
  ...
  onbSkip: 'Passer — commencer en N5',
  ...
  onbMapMilestone: (level, items, month) => `${level} terminé vers ${month} — ${items.toLocaleString('fr-FR')} éléments connus`,
  ...
  onbTourTodayDesc: 'Vos révisions dues, toutes lignes confondues — le rendez-vous quotidien qui fait tout tenir.',
  onbTourLinesTitle: 'Les lignes d’étude',
  onbTourLinesDesc: 'Kana, vocabulaire, kanji, grammaire — chaque ligne a ses modes, du QCM à l’écriture.',
  onbTourAnalyzerTitle: 'L’analyseur',
  onbTourAnalyzerDesc: 'Collez une phrase, une photo ou une vidéo : découpage, lectures, niveau — et minez-en des cartes.',
  onbTourExamsTitle: 'Les examens blancs',
  onbTourExamsDesc: 'Des épreuves au format JLPT, générées pour vous, chronométrées et corrigées.',
  ...
  settingsRedoPlacement: 'Refaire le test de niveau',
