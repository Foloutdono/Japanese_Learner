...
const profile = {
  ...
  punched:           'Poinçonnés',
  // Ce que vaut chaque 記念乗車券 — à lire en retournant le billet.
  badgeReq: {
    first_steps:   'Votre première révision.',
    week_streak:   "Sept jours d'affilée.",
    month_streak:  "Trente jours d'affilée.",
    kanji_100:     'Cent cartes maîtrisées.',
    perfectionist: "Dix sans-faute d'affilée.",
    dedicated:     'Cinq cents révisions.',
  },
  ranking:           'Classement',
  ...
  east:              'Est',
  west:              'Ouest',
  tonight:           'À portée ce soir',
  tonightDaruma:     (n) => `Encore ${n} et le daruma reçoit son second œil`,
  tonightBadge:      (n, glyph) => `Encore ${n} et le billet ${glyph} est poinçonné`,
  tonightChase:      (xp, who) => `${xp} XP pour dépasser ${who}`,
